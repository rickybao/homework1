...
```{r ans32}
b <- studentID == "046S6f645"
c <- schoolYear == "100"
credit100ChosenStudent <- sum(b*c*credit)
...
```{r ans33}
earnedCredit100ChosenStudent <- sum(b*c*earnedCredit)
...
```{r ans34}
gpa100ChosenStudent <- sum(b*c*grade*credit)/credit100ChosenStudent
gpa100ChosenStudent
```
